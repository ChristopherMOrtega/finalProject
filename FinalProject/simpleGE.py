...
class SuperSprite(pygame.sprite.Sprite):
    ...
    def __init__(self, scene):
        ...
        self.imageMaster = self.font.render(
            ">sprite>", True, (0, 0, 0), (0xFF, 0xFF, 0xFF)
        )
    ...
    def drawTrace(self, color=(0x00, 0x00, 0x00)):
        ...
        """
        pygame.draw.line(
            self.scene.background, color, self.oldCenter, self.rect.center, 3
        )
...
class MultiLabel(pygame.sprite.Sprite):
    ...
    def update(self):
        ...
        for lineNum in range(numLines):
            ...
            fontSurface = self.font.render(
                currentLine, True, self.fgColor, self.bgColor
            )
            # center the text
            xPos = (self.image.get_width() - fontSurface.get_width()) / 2
            yPos = lineNum * vSize
